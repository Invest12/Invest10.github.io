...
<body>
                    ...
                    <div class="dashboard-widgets">
                        <div class="widget">
                            ...
                            <div class="widget-meta" style="font-size: 12px; opacity: 0.7; margin-top: 8px;">
                                Level <span id="dashboardLevel">1</span> • Next level salary: $<span id="nextLevelSalary">400</span>
                            </div>
    ...
    <script>
                ...
                gameState.businessTypes.forEach(businessType => {
                    ...
                    div.innerHTML = `
                        ...
                        <div style="flex: 1;">
                            ...
                            <div style="font-size: 14px; color: var(--warning);">$${formatCurrency(businessType.basePrice)} • $${formatCurrency(businessType.baseIncome)}/hr</div>
                        </div>
                    `;
                ...
                gameState.insuranceTypes.forEach(insurance => {
                    ...
                    div.innerHTML = `
                        ...
                        <div style="flex: 1;">
                            ...
                            <div style="font-size: 14px; color: var(--warning);">$${formatCurrency(insurance.cost)} • ${(insurance.coverage * 100)}% Coverage</div>
                        </div>
        ...
        function resetGame() {
            if (confirm("⚠️ PERMANENT ACTION ⚠️\n\nAre you absolutely sure you want to reset your game?\n\nThis will permanently delete:\n• All your assets and progress\n• Your current level and achievements\n• All financial data and statistics\n• Stock holdings and businesses\n• Trading history and quests\n\nThis action cannot be undone!")) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                if (gameState.player.salaryCount === 0) {
                    showNotification("New Features Available", "🔥 Stock Market 📈 Player Trading 🏢 Business Empire 🎯 Daily Quests 🛡️ Insurance System", "info");
                }
            }, 8000);
        });
        ...
        console.log(`
        🎮 AssetMaster Pro Elite - Advanced Investment Simulator
        =====================================================
